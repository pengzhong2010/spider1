...
class WebpconeSpider(scrapy.spiders.Spider):
    ...
    def see_home(self, response):
        ...
        if m1:
            ...
            # url_fans = 'http://weibo.com/2714280233/fans?cfs=600&relate=fans&t=1&f=1&type=&Pl_Official_RelationFans__103_page=250#Pl_Official_RelationFans__103'
            next_url = 'http://weibo.com/p/1005052714280233/myfollow?cfs=600&relate=fans&t=1&f=1&type=&Pl_Official_RelationFans__93_page=' + str(
                self.next_page) + '#Pl_Official_RelationFans__93'
            # print "next_url"
            # print url_fans
